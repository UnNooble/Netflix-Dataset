...
st.write("Hi! My name is Barindra Surjaudaja and I will be attending Grade 10. Furthermore, I've had quite a bit of experienece with python coding using IDLE (eg: selection statements, loops, if statements, list, etc). However, this AI course has definately enhanced my knowledge regarding AI and the extraction of data and information to form data charts. This knowledge, without a doubt, will be very useful!")
